...
public class WordRecyclerAdapter extends RecyclerView.Adapter<WordRecyclerAdapter.SalmaHolder> {
    private ArrayList<Word> mDataset;
    private ItemClickListener onItemClickListener;

    public WordRecyclerAdapter(ItemClickListener listener, ArrayList<Word> myDataset) {
        mDataset = myDataset;
